...
export const ALICE = {
  uid: '-',
  password: 'd3e22075-f543-4e91-a7b2-22619ee45999',
  salt: '941b3f35-501b-4bb2-a511-eaddedf8d3cd',
  key: 'MjJhMmNhY2FlMzhhYzI4NzlmYjVhYTZlYWM2YTY3Njc2MjhjODBmOTQ3MThlMjYxMTQ3MWI0MTVhNzRkZDNmMzNjZTFhMTYyYTU0ODYwNmIwNTQxNzhiZTk2NjJkMDk3MDJkNDgzNmFlOWFkMjUzYjcwYzg0YjRhMmViNjM2NjY=',
}

export const BIG_JSON = {
